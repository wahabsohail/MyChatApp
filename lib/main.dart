...
import 'package:mychatapp/chat.dart';
import 'package:mychatapp/const.dart';
import 'package:mychatapp/login.dart';
import 'package:mychatapp/settings.dart';
...
class MainScreenState extends State<MainScreen> {
  ...
  void showNotification(message) async {
    var androidPlatformChannelSpecifics = new AndroidNotificationDetails(
      Platform.isAndroid ? 'com.example.mychatapp': 'com.example.mychatapp',
      'Flutter chat demo',
