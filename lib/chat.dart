...
import 'package:mychatapp/fullPhoto.dart';
      ...
      child: Column(
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              FlatButton(
                onPressed: () => onSendMessage('animated', 2),
                child: new Image.asset(
              ...
              FlatButton(
                onPressed: () => onSendMessage('animated2', 2),
                child: new Image.asset(
                  'assets/images/animated2.gif',
                  width: 50.0,
                  height: 50.0,
                  fit: BoxFit.cover,
                ),
              ...
              FlatButton(
                onPressed: () => onSendMessage('animated3', 2),
                child: new Image.asset(
                  'assets/images/animated3.gif',
                  width: 50.0,
                  height: 50.0,
                  fit: BoxFit.cover,
                ),
